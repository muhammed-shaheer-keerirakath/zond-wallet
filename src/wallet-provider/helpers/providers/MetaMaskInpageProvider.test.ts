...
import { MockConnectionStream } from "../tests/mocks/MockConnectionStream";
    ...
    beforeEach(() => {
      ...
      jest
        ...
        .mockImplementation((_payload, callback: any, _isInternal) =>
          // eslint-disable-next-line n/no-callback-literal
          callback(...(mockRpcRequestResponse() as [any, any])),
        );
    });
